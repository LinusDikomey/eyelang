...
pub fn type_layout<'a>(ty: IrType, types: &IrTypes) -> Layout {
    ...
    match ty {
        ...
        T::I16 | T::U16 => Layout {
            size: 2,
            align: 2.try_into().unwrap(),
        },
        T::I32 | T::U32 | T::F32 => Layout {
            size: 4,
            align: 4.try_into().unwrap(),
        },
        T::I64 | T::U64 | T::F64 => Layout {
            size: 8,
            align: 8.try_into().unwrap(),
        },
        T::I128 | T::U128 => Layout {
            size: 16,
            align: 16.try_into().unwrap(),
        },
        T::Unit => Layout::EMPTY,
        T::Ptr => Layout::PTR, // TODO: architecture dependent pointer sizes
        IrType::Array(elem_ty, count) => {
            Layout::array(type_layout(types[elem_ty], types), count as u64)
        }
        IrType::Tuple(elems) => {
