...
// impl<C: Representer, T: TreeToken> Repr<C> for Expr<T> {
//     fn repr(&self, c: &C) {
//         let ast = c.ast();
//         match self {
//             &Self::Error(span) => {
...
//             | Self::StringLiteral { span, .. } => c.write_add(c.src(*span)),
//             Self::EnumLiteral { ident, args, .. } => {
//                 c.char('.');
...
//             Self::Hole { .. } => c.char('_'),
//             Self::Array { elements, .. } => {
//                 let mut elems = ast[*elements].iter();
//                 c.char('[');
...
//             }
//             Self::Tuple { elements, .. } => {
//                 let mut elems_iter = ast[*elements].iter();
//                 c.char('(');
