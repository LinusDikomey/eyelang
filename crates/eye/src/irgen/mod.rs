...
struct Ctx<'a> {
    ...
    module: ModuleId,
    checked_function_body: &'a CheckedFunctionBody,
...
impl<'a> Index<ExprId> for Ctx<'a> {
    type Output = LocalTypeId;
...
impl<'a> Index<VarId> for Ctx<'a> {
    ...
    fn index(&self, index: VarId) -> &Self::Output {
        self.checked_function_body.var_types
        &self.var_values[index.idx()]
    }
}
