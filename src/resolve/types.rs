...
use crate::{types::{Primitive, Layout}, dmap::DHashMap, ast::ModuleId};

use super::{const_val::ConstVal, type_info::{TypeInfo, TypeTable, TypeTableIndices, TypeInfoOrIndex}};
...
impl SymbolTable {
    ...
    pub fn place_type(&mut self, id: TypeId, ty: TypeDef) {
        self.types[id.0 as usize].1 = MaybeTypeDef::Some(ty);
    }
    ...
    pub fn get_type(&self, id: TypeId) -> &TypeDef {
        let MaybeTypeDef::Some(def) = &self.types[id.0 as usize].1 else {
